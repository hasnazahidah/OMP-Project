<?php
/* Smarty version 4.3.1, created on 2023-12-04 03:35:03
  from 'app:workflowworkflow.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_656d3ad76a0d44_11335032',
...
function content_656d3ad76a0d44_11335032 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_834410609656d3ad765cdd0_87167935', "page");
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "layouts/backend.tpl");
}
/* {block "page"} */
class Block_834410609656d3ad765cdd0_87167935 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_834410609656d3ad765cdd0_87167935',
  ),
);
...
?>
	...
	<pkp-header :is-one-line="true" class="pkpWorkflow__header">
		...
		<template slot="actions">
			...
			>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"common.view"),$_smarty_tpl ) );?>

			</pkp-button>
			<dropdown
				class="pkpWorkflow__identificationWorkType"
				:label="workTypeLabel"
				submenu-label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"submission.workflowType.change"),$_smarty_tpl ) );?>
"
			>
				<ul>
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
		...
		<tab id="marketing" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"settings.libraryFiles.category.marketing"),$_smarty_tpl ) );?>
">
			<tabs :is-side-tabs="true" :track-history="true" :label="publicationTabsLabel">
				<tab id="audience" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"monograph.audience"),$_smarty_tpl ) );?>
">
					<pkp-form v-bind="components.<?php echo (defined('FORM_AUDIENCE') ? constant('FORM_AUDIENCE') : null);?>
" @set="set" />
				</tab>
				<tab id="representatives" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"grid.catalogEntry.representatives"),$_smarty_tpl ) );?>
">
					<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', 'representativesGridUrl', null);
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_COMPONENT') ? constant('ROUTE_COMPONENT') : null),'component'=>"grid.catalogEntry.RepresentativesGridHandler",'op'=>"fetchGrid",'submissionId'=>$_smarty_tpl->tpl_vars['submission']->value->getId(),'escape'=>false),$_smarty_tpl ) );
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['load_url_in_div'][0], array( array('id'=>"representativesGridContainer",'url'=>$_smarty_tpl->tpl_vars['representativesGridUrl']->value),$_smarty_tpl ) );?>

				</tab>
				<tab id="publicationDates" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"grid.catalogEntry.publicationDates"),$_smarty_tpl ) );?>
">
					<pkp-form v-bind="components.<?php echo (defined('FORM_PUBLICATION_DATES') ? constant('FORM_PUBLICATION_DATES') : null);?>
" @set="set" />
				</tab>
			</tab>
		</tab>
						...
						<?php if ($_smarty_tpl->tpl_vars['canAccessProduction']->value) {?>
							<template slot="actions">
								<pkp-button
									...
									@click="openPublish"
								>
									<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"publication.publish"),$_smarty_tpl ) );?>
...
">
						...
						<tab id="chapters" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"submission.chapters"),$_smarty_tpl ) );?>
">
...
" @set="set" />
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['canAccessProduction']->value) {?>
							<tab id="publicationFormats" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"submission.publicationFormats"),$_smarty_tpl ) );?>
">
								<div id="representations-grid" ref="representations">
									<spinner></spinner>
								</div>
							</tab>
							<tab id="catalogEntry" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"publication.catalogEntry"),$_smarty_tpl ) );?>
">
								<pkp-form v-bind="components.<?php echo (defined('FORM_CATALOG_ENTRY') ? constant('FORM_CATALOG_ENTRY') : null);?>
" @set="set" />
							</tab>
